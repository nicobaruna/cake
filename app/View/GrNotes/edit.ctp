<div class="col-md-10">
	<div class="purchaseOrders content col-md-9">
	...
	<div class="col-md-3">
		<div class="action block">
			...
			<div class="content list-group">
				<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PurchaseOrder.id')),array('class'=>'list-group-item'), null, __('Are you sure you want to delete # %s?', $this->Form->value('PurchaseOrder.id'))); ?></li>
				<li><?php echo $this->Html->link(__('List Gr Note'), array('action' => 'index'),array('class'=>'list-group-item')); ?></li>
				<li><?php echo $this->Html->link(__('List Users'), array('controller' => 'users', 'action' => 'index'),array('class'=>'list-group-item')); ?> </li>
				<li><?php echo $this->Html->link(__('New User'), array('controller' => 'users', 'action' => 'add'),array('class'=>'list-group-item')); ?> </li>
			</div>
		</div>
	</div>
