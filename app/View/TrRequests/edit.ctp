<div class="col-md-10">
	<div class="trRequests form edit col-md-9">
		...
		<div class="block">
			...
			<div class="content">
				<div class="form-row">
					...
					<div class="col-md-6">
						<!-- insert purchase request input here -->
					</div>
				</div>
				<div class="form-row">
					<div class="col-md-3">
	...
	<div class="col-md-3">
		<div class="actions block">
			...
			<div class="content list-group">
				<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('TrRequest.id')),array('class'=>'list-group-item'), null, __('Are you sure you want to delete # %s?', $this->Form->value('TrRequest.id'))); ?>
