			...
			<div class="block">
				...
				<div class="content item-table" data-items="" data-total="">
					<table class="table table-bordered table-striped table-hover">
						...
						?>
							<tr class="item">
								<td><?php echo $this->Form->input('TrFixPurchaseOrder.'.$count.'.stock_id',array('label'=>false,'class'=>'stock')); ?></td>
								<td><?php echo $this->Form->input('TrFixPurchaseOrder.'.$count.'.qty',array('label'=>false));?></td>
								<td><?php echo $this->Form->input('TrFixPurchaseOrder.'.$count.'.big_unit_id',array('label'=>False,'options'=>$bigUnits,'default'=>$item['big_unit_id'],'class'=>'bigUnit')); ?></td>
