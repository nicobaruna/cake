...
<?php echo $this->Form->create('WarehouseHistory'); ?>
	<fieldset>
		<legend><?php echo __('Edit Warehouse History'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('WarehouseHistory.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('WarehouseHistory.id'))); ?></li>
