...
<div class="related">
	<h3><?php echo __('Related Big Units'); ?></h3>
...
<div class="related">
	<h3><?php echo __('Related Tr Fix Puchase Orders'); ?></h3>
...
<div class="related">
	<h3><?php echo __('Related Tr Grnotes'); ?></h3>
...
<div class="related">
	<h3><?php echo __('Related Tr Pos'); ?></h3>
