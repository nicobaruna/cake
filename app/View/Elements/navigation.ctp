      ...
      <nav class="navbar brb" role=navigation>
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav">
            <li class=active> <a href="<?php echo $this->base; ?>"> <span class=icon-home></span> dashboard </a> </li>
            <li class=dropdown> <a href=# class=dropdown-toggle data-toggle=dropdown><span class=icon-pencil></span> Warehouse Documents</a>
              <ul class=dropdown-menu>
                <li><a href="<?php echo $this->base; ?>/purchase_requests/">Purchase Request</a></li>
                <li><a href="<?php echo $this->base; ?>/purchase_orders/">Purchase Order</a></li>
                <li><a href="<?php echo $this->base; ?>/grnotes/">GR Notes</a></li>
                <li><a href="<?php echo $this->base; ?>/fixed_purchase_orders/">Fixed PO</a></li>
              </ul>
            </li>
            <li class=dropdown> <a href=# class=dropdown-toggle data-toggle=dropdown><span class=icon-pencil></span> Warehousing Setting</a>
              <ul class=dropdown-menu>
                <li><a href="<?php echo $this->base; ?>/stocks/">Stocks</a></li>
                <li><a href="<?php echo $this->base; ?>/warehouses/">Warhouses</a></li>
                 <li><a href="<?php echo $this->base; ?>/Units/">Units</a></li>
              </ul>
            </li>
