...
<?php echo $this->Form->create('TrPo'); ?>
	<fieldset>
		<legend><?php echo __('Edit Tr Po'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('TrPo.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('TrPo.id'))); ?></li>
