<div class="trPos view col-md-10">
	...
	<div class="trPos-detail col-md-8">
		<div class="block">
	...
	<div class="actions col-md-4">
		<div class="block">
			...
			<div>
				<span class="btn btn-default"><?php echo $this->Html->link(__('Edit Tr Po'), array('action' => 'edit', $trPo['TrPo']['id'])); ?> </span>
				<span class="btn btn-default"><?php echo $this->Form->postLink(__('Delete Tr Po'), array('action' => 'delete', $trPo['TrPo']['id']), null, __('Are you sure you want to delete # %s?', $trPo['TrPo']['id'])); ?> </span>
